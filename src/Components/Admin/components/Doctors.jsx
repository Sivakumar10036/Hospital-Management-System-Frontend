...

  {
    ...
    renderCell: (params) => {
      const handleDelete = async () => {
        ...
        try {
          await axios.delete(
            `https://hospital-management-system-backend-8.onrender.com/doctor/${params.row._id}`,
            {
              headers: {
...
export default function DataGridDemo() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://hospital-management-system-backend-8.onrender.com/public/doctor", {
        headers: {
          "Content-Type": "application/json",
