...
function Report() {
 ...
 const fetchdata = async () => {
    try {
      const response = await axios.get(`https://hospital-management-system-backend-8.onrender.com/single/${id}`, {
        headers: {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
        const response = await axios.patch(`https://hospital-management-system-backend-8.onrender.com/update-medicine`, {_id:id,medicine,about}, {
          headers: {
            'Content-Type': 'application/json',
            authorization: localStorage.getItem('jwt'),
          },
